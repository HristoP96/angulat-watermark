 ...
 * @hidden 
 */
export class TemplateSectionHeaderCellModelExport extends SectionHeaderCellModelExport {
	static $t: Type = markType(TemplateSectionHeaderCellModelExport, 'TemplateSectionHeaderCellModelExport', (<any>SectionHeaderCellModelExport).$type);
