 ...
 * @hidden 
 */
export class CanvasVerticalSeparatorCellPresenter extends CanvasCellPresenterBase {
	static $t: Type = markType(CanvasVerticalSeparatorCellPresenter, 'CanvasVerticalSeparatorCellPresenter', (<any>CanvasCellPresenterBase).$type);
