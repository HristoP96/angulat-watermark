 ...
 * @hidden 
 */
export class ImageCellPresenter extends CellPresenterBase {
	static $t: Type = markType(ImageCellPresenter, 'ImageCellPresenter', (<any>CellPresenterBase).$type);
	constructor(cell: GridCellBase) {
		super(cell);
	}
	get imageCell(): ImageCell {
	...
	private updateImageStretch(imageStretchOption: ImageStretchOptions, horizontalAlignment: CellContentHorizontalAlignment, verticalAlignment: CellContentVerticalAlignment): void {
		this.imageCell.setStretchOptions(imageStretchOption);
	}
