...
import { IgxLinearGaugeCoreDynamicModule } from './igx-linear-gauge-core-dynamic-module';
import { IgxDVInteractivityDynamicModule } from 'igniteui-core/igx-dv-interactivity-dynamic-module';
import { IgxLinearGaugeModule } from './igx-linear-gauge-module'
...
export class IgxLinearGaugeDynamicModule {
