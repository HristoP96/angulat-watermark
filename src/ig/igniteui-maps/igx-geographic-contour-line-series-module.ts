...
import { IgxScatterContourSeriesDynamicModule } from 'igniteui-charts/igx-scatter-contour-series-dynamic-module';
...
export class IgxGeographicContourLineSeriesModule {
