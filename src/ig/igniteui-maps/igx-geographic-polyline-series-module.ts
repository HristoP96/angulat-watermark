...
import { IgxScatterPolylineSeriesDynamicModule } from 'igniteui-charts/igx-scatter-polyline-series-dynamic-module';
...
export class IgxGeographicPolylineSeriesModule {
