...
export class MarketFacilitationIndexIndicatorStrategy extends ItemwiseIndicatorCalculationStrategy {
	static $t: Type = markType(MarketFacilitationIndexIndicatorStrategy, 'MarketFacilitationIndexIndicatorStrategy', (<any>ItemwiseIndicatorCalculationStrategy).$type);
