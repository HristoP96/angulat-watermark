 ...
 * @hidden 
 */
export class RadialAxisRenderingParameters extends CategoryAxisRenderingParameters implements IPolarRadialRenderingParameters {
	static $t: Type = markType(RadialAxisRenderingParameters, 'RadialAxisRenderingParameters', (<any>CategoryAxisRenderingParameters).$type, [IPolarRadialRenderingParameters_$type]);
