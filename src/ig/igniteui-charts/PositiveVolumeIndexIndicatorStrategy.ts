...
export class PositiveVolumeIndexIndicatorStrategy extends IndicatorCalculationStrategy {
	static $t: Type = markType(PositiveVolumeIndexIndicatorStrategy, 'PositiveVolumeIndexIndicatorStrategy', (<any>IndicatorCalculationStrategy).$type);
