...
export class PositiveVolumeIndexIndicator extends StrategyBasedIndicator {
	static $t: Type = markType(PositiveVolumeIndexIndicator, 'PositiveVolumeIndexIndicator', (<any>StrategyBasedIndicator).$type);
	...
	protected get_styleKeyType(): Type {
		return (<any>PositiveVolumeIndexIndicator).$type;
	}
