 ...
 * @hidden 
 */
export class Stacked100LineSeries extends StackedLineSeries implements IStacked100Series {
	static $t: Type = markType(Stacked100LineSeries, 'Stacked100LineSeries', (<any>StackedLineSeries).$type, [IStacked100Series_$type]);
	constructor() {
		super();
		this.defaultStyleKey = (<any>Stacked100LineSeries).$type;
	}
