 ...
 * @hidden 
 */
export abstract class IndicatorCalculationStrategy extends Base {
	static $t: Type = markType(IndicatorCalculationStrategy, 'IndicatorCalculationStrategy');
	abstract calculateIndicator(dataSource: FinancialCalculationDataSource, supportingCalculations: FinancialCalculationSupportingCalculations): boolean;
