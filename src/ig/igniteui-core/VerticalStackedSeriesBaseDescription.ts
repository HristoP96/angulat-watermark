 ...
 * @hidden 
 */
export abstract class VerticalStackedSeriesBaseDescription extends StackedSeriesBaseDescription {
	static $t: Type = markType(VerticalStackedSeriesBaseDescription, 'VerticalStackedSeriesBaseDescription', (<any>StackedSeriesBaseDescription).$type);
