 ...
 * @hidden 
 */
export class GeographicMapScatterSeriesDescriptionCoreModule extends Base {
	static $t: Type = markType(GeographicMapScatterSeriesDescriptionCoreModule, 'GeographicMapScatterSeriesDescriptionCoreModule');
