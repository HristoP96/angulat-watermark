...
export class GeographicScatterAreaSeriesDescription extends GeographicXYTriangulatingSeriesDescription {
	static $t: Type = markType(GeographicScatterAreaSeriesDescription, 'GeographicScatterAreaSeriesDescription', (<any>GeographicXYTriangulatingSeriesDescription).$type);
