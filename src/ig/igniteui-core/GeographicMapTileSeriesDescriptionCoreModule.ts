 ...
 * @hidden 
 */
export class GeographicMapTileSeriesDescriptionCoreModule extends Base {
	static $t: Type = markType(GeographicMapTileSeriesDescriptionCoreModule, 'GeographicMapTileSeriesDescriptionCoreModule');
