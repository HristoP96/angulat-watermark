...
export class MovingAverageConvergenceDivergenceIndicatorDescription extends StrategyBasedIndicatorDescription {
	static $t: Type = markType(MovingAverageConvergenceDivergenceIndicatorDescription, 'MovingAverageConvergenceDivergenceIndicatorDescription', (<any>StrategyBasedIndicatorDescription).$type);
