 ...
 * @hidden 
 */
export abstract class HorizontalAnchoredCategorySeriesDescription extends AnchoredCategorySeriesDescription {
	static $t: Type = markType(HorizontalAnchoredCategorySeriesDescription, 'HorizontalAnchoredCategorySeriesDescription', (<any>AnchoredCategorySeriesDescription).$type);
