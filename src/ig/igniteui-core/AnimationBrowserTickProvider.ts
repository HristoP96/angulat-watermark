...
import { Base, IEnumerator$1, IEnumerator$1_$type, IEnumerable$1, IEnumerable$1_$type, IEnumerator, IEnumerator_$type, IDisposable, IDisposable_$type, Number_$type, Delegate_$type, fromEnum, runOn, Type, markType } from "./type";
import { ITickProvider, ITickProvider_$type } from "./ITickProvider";
 ...
 * @hidden 
 */
export class AnimationBrowserTickProvider extends Base implements ITickProvider {
	static $t: Type = markType(AnimationBrowserTickProvider, 'AnimationBrowserTickProvider', (<any>Base).$type, [ITickProvider_$type]);
