...
export class NumericCellInfoDescription extends CellInfoDescription {
	static $t: Type = markType(NumericCellInfoDescription, 'NumericCellInfoDescription', (<any>CellInfoDescription).$type);
	...
	set hasDecimalValue(value: boolean) {
		...
		this.markDirty("HasDecimalValue");
	}
