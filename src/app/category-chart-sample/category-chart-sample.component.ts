...
@Component({
  ...
  selector: "category-chart-sample",
  styleUrls: ["./category-chart-sample.component.scss"],
  templateUrl: "./category-chart-sample.component.html"
})
export class CategoryChartSampleComponent implements AfterViewInit, OnDestroy {
