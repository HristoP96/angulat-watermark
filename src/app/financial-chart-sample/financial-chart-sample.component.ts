...
import { IgxFinancialChartComponent } from 'igniteui-charts/igx-financial-chart-component';

@Component({
  changeDetection: ChangeDetectionStrategy.OnPush,
  selector: "app-financial-chart-sample",
  styleUrls: ["./financial-chart-sample.component.scss"],
  templateUrl: "./financial-chart-sample.component.html"
})
export class FinancialChartSampleComponent implements AfterViewInit, OnDestroy {
